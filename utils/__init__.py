...
from .patches import imread, imshow, imwrite, torch_load, torch_save  # for patches
...
AUTOINSTALL = str(os.getenv("YOLO_AUTOINSTALL", True)).lower() == "false"  # global auto-install mode
